...
public class MessageResponse {
    ...
    public MessageResponse(Long id, String content, MessageType type, MessageState state, String senderId, String receiverId, LocalDateTime createdAt, byte[] media, String mediaUrl) {
        this.id = id;
